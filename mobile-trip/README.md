...
- 回憶：3 種 CSS 版型示意、本機照片預覽、購買資格與公開景點收藏流程。不呼叫生圖 AI，不傳送照片或發文。
...
從根目錄執行 node work/build-mobile-content.cjs 更新共用景點/文件資料；node work/package-mobile.cjs 更新本地 GitHub Pages 發布包與 OpenDesign 入口。此指令不會發布外部網站。
